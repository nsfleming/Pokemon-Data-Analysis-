...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dupe\_rows}\OtherTok{\textless{}{-}} \FunctionTok{duplicated}\NormalTok{(pokemonData}\SpecialCharTok{$}\NormalTok{X.)}
\NormalTok{pokemonNoDupes}\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(pokemonData,}\SpecialCharTok{!}\NormalTok{dupe\_rows)}
\FunctionTok{summary}\NormalTok{(pokemonNoDupes)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Nathaniel-Fleming_Assignment_3_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Filter out blank values that are just spaces in the Type.2 column}
\NormalTok{multi\_type\_pokemon }\OtherTok{\textless{}{-}}\NormalTok{ pokemonNoDupes[}\FunctionTok{nchar}\NormalTok{(}\FunctionTok{trimws}\NormalTok{(pokemonNoDupes}\SpecialCharTok{$}\NormalTok{Type}\FloatTok{.2}\NormalTok{)) }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, ]}

\CommentTok{\# Filter out blank values in the Type.2 column}
\NormalTok{multi\_type\_pokemon}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Single Type pokemon }
\CommentTok{\# Filter for empty values in the Type.2 column}
\NormalTok{Single\_Type\_Pokemon }\OtherTok{\textless{}{-}}\NormalTok{ pokemonNoDupes[}\FunctionTok{is.na}\NormalTok{(pokemonNoDupes}\SpecialCharTok{$}\NormalTok{Type}\FloatTok{.2}\NormalTok{) }\SpecialCharTok{|} \FunctionTok{nchar}\NormalTok{(}\FunctionTok{trimws}\NormalTok{(pokemonNoDupes}\SpecialCharTok{$}\NormalTok{Type}\FloatTok{.2}\NormalTok{)) }\SpecialCharTok{==} \DecValTok{0}\NormalTok{, ]}
\NormalTok{Single\_Type\_Pokemon}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Nathaniel-Fleming_Assignment_3_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# calculate frequency of each type}
\NormalTok{type\_freq }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(pokemonNoDupes}\SpecialCharTok{$}\NormalTok{Type}\FloatTok{.1}\NormalTok{)}

\CommentTok{\# convert table to data frame and sort by frequency}
\NormalTok{type\_freq\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Type =} \FunctionTok{names}\NormalTok{(type\_freq), }\AttributeTok{Freq =} \FunctionTok{as.vector}\NormalTok{(type\_freq))}
\NormalTok{type\_freq\_df }\OtherTok{\textless{}{-}}\NormalTok{ type\_freq\_df[}\FunctionTok{order}\NormalTok{(type\_freq\_df}\SpecialCharTok{$}\NormalTok{Freq, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{), ]}

\CommentTok{\# create bar plot}
\NormalTok{Type\_Freq }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(type\_freq\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{reorder}\NormalTok{(Type, }\SpecialCharTok{{-}}\NormalTok{Freq), }\AttributeTok{y =}\NormalTok{ Freq, }\AttributeTok{fill =}\NormalTok{ Type)) }\SpecialCharTok{+}
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat =} \StringTok{"identity"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values =}\NormalTok{ pokemon\_colors) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Type"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Frequency"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Frequency of Pokemon Types"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{angle =} \DecValTok{90}\NormalTok{, }\AttributeTok{vjust =} \FloatTok{0.5}\NormalTok{),}\AttributeTok{legend.position =} \StringTok{\textquotesingle{}none\textquotesingle{}}\NormalTok{)}
  
  \FunctionTok{ggsave}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(file\_path,}\StringTok{"Pokemon\_Freq\_by\_Type.png"}\NormalTok{),}\AttributeTok{plot =}\NormalTok{ Type\_Freq)}
\end{Highlighting}
\end{Shaded}
